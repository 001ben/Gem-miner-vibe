...
import { BulldozerRenderer } from '../domains/bulldozer/view.js';
...
function loadBulldozerAssets() {
    bulldozerRenderer.load('assets/models/bulldozer_components.glb', 'src/domains/bulldozer/config.json').catch(err => {
